...
export default function Footer() {
  return (
    <>
      {/* Newsletter Section */}
     <div  className="w-full max-w-[1240px] h-[200px] bg-black text-white mx-auto p-6 sm:p-8 md:p-12 lg:p-[36px] rounded-tl-[20px] rounded-br-[20px] flex flex-col sm:flex-row justify-between items-center">
        {/* Left side text */}
        <div className="flex flex-col justify-start">
          <h2
            className="text-white text-[32px] sm:text-[38px] md:text-[64px] font-bold text-left leading-[32px] sm:leading-[48px] md:leading-[64px] font-integral"
            style={{
      ...
      {/* Footer Section */}
      <div className="w-full bg-[#F0F0F0] text-BLACK mx-auto p-10 flex flex-col gap-10 lg:h-auto">
        {/* Shop.co and Social Media Icons */}
        <div className="flex flex-col items-start gap-4">
          {/* Shop.co Heading */}
          <h3 className="text-[16px] font-normal leading-[19px]">Shop.co</h3>
          
          {/* Paragraph text */}
          <p className="text-gray-700 text-[14px] leading-[18px]">
        ...
        {/* Horizontal Layout for Company, Services, and Support */}
        <div className="flex flex-col lg:flex-row justify-between w-full mt-10 gap-10">
          {/* Company Section */}
          <div className="flex flex-col gap-[35px] w-[280px]">
            <h2 className="font-normal text-[16px] leading-[19px] text-left">COMPANY</h2>
            <ul className="text-[16px] font-normal leading-[19px] text-left">
              <li>
          ...
          {/* Services Section */}
          <div className="flex flex-col gap-[34px] w-[280px]">
            <h2 className="font-normal text-[16px] leading-[19px] text-left">SERVICES</h2>
            <ul className="text-[16px] font-normal leading-[19px] text-left">
              <li>
          ...
          {/* Support Section */}
          <div className="flex flex-col gap-[34px] w-[280px]">
            <h2 className="font-normal text-[16px] leading-[19px] text-left">SUPPORT</h2>
            <ul className="text-[16px] font-normal leading-[19px] text-left">
              <li>
          ...
          <div className="flex flex-row items-center justify-start mt-60">
